...
   * Extrai o primeiro token (data no formato dd/mm/aaaa) de cada entrada para identificar o mês.
   *******************/
  function extrairNomeMes(dataStr) {
    const token = dataStr.split(" ")[0]; // Pega o primeiro token (antes do espaço)
...
   * Atualiza também a célula "Data de Atendimento" para exibir somente as datas do mês filtrado.
   *******************/
...
   * Captura TODOS os campos, monta a linha resumo e armazena os dados completos em data-full.
   *******************/
...
    // Processa as datas: para cada entrada separada por vírgula, extrai o primeiro token (data) para criar mapaDatas.
    let mapaDatas = {};
...
    // Monta a linha resumo (Exibe: Nº Prontuário | Situação Atual | Nome da CRIAD | Data de Atendimento)
    const summaryHTML = `
